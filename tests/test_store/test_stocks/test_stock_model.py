...
def test_stock_model_instance():
    assert isinstance(stock_model_instance, StockModel), "stock model instance not instantiating correctly"
    assert isinstance(stock_instance, Stock), "Stock not instantiating correctly"
    assert isinstance(broker_instance, Broker), "Broker not instantiating correctly"
