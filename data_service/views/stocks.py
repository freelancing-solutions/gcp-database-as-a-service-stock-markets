...
class StockView(CatchStockErrors, CatchBrokerErrors):
    ...
    # noinspection DuplicatedCode
    @get_net_volume_data
    def create_net_volume(self, stock_id: str, date_created: date_class, transaction_id: str, net_volume: str, net_value: str,
    ...
    @cache_stock_buys_sells.cached(timeout=return_ttl(name='medium'), unless=end_of_month)
    def get_buy_volume(self, transaction_id: str = None, date_created: date_class = None, stock_id: str = None) -> tuple:
        """
    ...
    @cache_stock_buys_sells.cached(timeout=return_ttl(name='medium'), unless=end_of_month)
    def get_sell_volume(self, transaction_id: str = None, date_created: date_class = None, stock_id: str = None) -> tuple:
        """
    ...
    @cache_stock_buys_sells.cached(timeout=return_ttl(name='medium'), unless=end_of_month)
    def get_net_volume(self, transaction_id: str = None, date_created: date_class = None, stock_id: str = None) -> tuple:
        with self.client.context():
